...
<div className='lg:grid lg:grid-cols-6 md:grid md:grid-cols-3 grid grid-cols-2 items-center justify-between gap-4 my-10'>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/smartphone.png" alt="icon-1" width={40} height={40} />
            </div>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/monitor.png" alt="icon-1" width={40} height={40} />
            </div>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/smartwatch.png" alt="icon-1" width={40} height={40} />
            </div>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/camera.png" alt="icon-1" width={40} height={40} />
            </div>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/headphones.png" alt="icon-1" width={40} height={40} />
            </div>
          ...
          <div className='w-full h-40 items-center justify-center p-10 border border-gray-300 cursor-pointer hover:bg-red-500'>
            <div className='mx-6'>
              <Image src="/game-boy.png" alt="icon-1" width={40} height={40} />
            </div>
