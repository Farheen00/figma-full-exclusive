    ...
    <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-10'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-9.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-10.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-11.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-12.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-13.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-14.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-15.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
          ...
          <div className='bg-white rounded-md flex flex-col justify-between w-full h-full'>
            <div className='bg-slate-200 p-3 flex flex-col flex-grow'>
              ...
              <Image src="/img-16.png" alt='controller' width={400} height={400} className='object-contain' />
            </div>
            <div className='p-3'>
